...
Для удобства разработки и тестирования все сервисы проекта описаны в файле `docker-compose.yml`. С помощью этого файла вы сможете развернуть приложение на вашем локальном компьютере. Для того чтобы запустить проект, выполните команду:
